...
const learnSources = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Show Your Work!', desc: 'Austin Kleon — share creativity, get discovered' },
      { name: 'Steal Like an Artist', desc: 'Austin Kleon — unlock creativity through remixing' },
      { name: 'The Lean Startup', desc: 'Eric Ries — iterative innovation and testing' },
      { name: 'Hooked', desc: 'Nir Eyal — creating engaging user habits' },
      { name: 'Work for Money, Design for Love', desc: 'David Airey — guide for freelance designers' },
      { name: 'Web Style Guide, 4th Edition', desc: 'Lynch & Horton — foundations of user experience design' },
      { name: '100 Things Every Presenter Needs to Know', desc: 'Susan Weinschenk — psychology of effective presentations' },
      { name: 'Laws of UX', desc: 'Jon Yablonski — psychology principles for persuasive and ethical products' },
    ],
  },
  {
    ...
    items: [
      { name: 'Nielsen Norman Group', desc: 'The gold standard of UX research (nngroup.com)' },
